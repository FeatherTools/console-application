module Feather.ConsoleApplication.Tests.CommandDefinitions
...
let defineCommandTests =
    testList "ConsoleApplication - define command" [
        ...
        testCase "Test should just compile with all keywords" <| fun _ ->
            let customTag: Feather.ConsoleStyle.CustomTag = { Tag = Feather.ConsoleStyle.TagName "tag"; Markup = Feather.ConsoleStyle.MarkupString "<c:yellow>" }
            ...
            let app =
                consoleApplication {
                    title "Feather.ConsoleApplication"
                    name "Example"
                    version "1.0.0"
                    ...
                    withStyle Feather.ConsoleStyle.Style.defaults
                    withCustomTags [
                        customTag
                    ]
                    withCustomTags [
                        Feather.ConsoleStyle.CustomTag.createAndParseMarkup (Feather.ConsoleStyle.TagName "name") "<c:black|bg:cyan>"
                    ]
